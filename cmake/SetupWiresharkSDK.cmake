...
elseif(UNIX)
    ...
    # 1. Try to find System Wireshark
    ...
    if(Wireshark_FOUND)
        if(WS_VERSION_DEFINED)
            ...
            if(NOT "${Wireshark_VERSION}" VERSION_EQUAL "${WS_FULL_VERSION}")
                message(STATUS "System Wireshark version (${Wireshark_VERSION}) does not match requested (${WS_FULL_VERSION}). Bootstrapping local SDK...")
                set(NEED_BOOTSTRAP TRUE)
            else()
                message(STATUS "Found System Wireshark ${Wireshark_VERSION}. Using it.")
            endif()
        else()
            message(STATUS "Found System Wireshark ${Wireshark_VERSION}. Using it.")
        endif()
